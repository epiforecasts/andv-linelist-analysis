...
See the [rendered analysis walkthrough](https://epiforecasts.io/andv-linelist-analysis/dev/analysis) for fitted results and [LIMITATIONS.md](https://github.com/sbfnk/hantavirus/blob/main/LIMITATIONS.md) for known caveats.
